...
import com.diewland.android.qr_pp_40.helper.FrameMetadata;
import com.diewland.android.qr_pp_40.helper.GraphicOverlay;
import com.diewland.android.qr_pp_40.helper.TextGraphic;
import com.diewland.android.qr_pp_40.helper.VisionProcessorBase;
      ...
      for (int j = 0; j < lines.size(); j++) {
        ...
        for (int k = 0; k < elements.size(); k++) {
          ...
          if(android.text.TextUtils.isDigitsOnly(t_str)){
              ...
              // detect Thai ID Card No
              if(text_acc_id.length() == 13){
                  Activity act = (Activity) previewCtx;
                  Intent intent = new Intent();
                  intent.putExtra("ACC_ID", text_acc_id);
